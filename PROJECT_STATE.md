...
> Last verified: Phase 26 (Comparator Source Management), 2026-09-10.
...
dev-only gallery, **sixty-six tables, all with RLS on and 230 policies between them, plus the first
...
| 27–46 | Extraction, normalization, review, ops, launch | **PLANNED** | Specified in `docs/project/phases/`. |
