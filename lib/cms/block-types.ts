 ...
 * page needs (amendment A14) and the two the project archive needs (Phase 17).
 *
 ...
 *
 * ALL 32 ARE LISTED EVEN THOUGH NOT ALL ARE BUILT. The alternative — listing only what ships —
