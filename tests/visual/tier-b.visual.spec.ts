...
import { TIER_B, TOLERANCE } from './tiers'
import { settle, stabilise } from './stability'

/**
 * Tier B — the rest of the public site — Phase 42.
 *
...
test.describe('Tier B — the rest of the public site', () => {
  for (const route of TIER_B) {
