 ...
 * audit row when it refuses, and is the same call the finished surface will make. Phase 17
...
export default async function Page() {
  ...
  return <StudioPage path="/studio/content/testimonials" />
}
