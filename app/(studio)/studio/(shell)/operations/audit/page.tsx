 ...
 * holding `operations.audit.read`, and a link that 404s is worse than a page saying it is not built.
 *
 * THE PERMISSION CHECK IS REAL, not a placeholder. It runs before anything renders, writes a DENIED
 * audit row when it refuses, and is the same call the finished surface will make. Phase 04
...
export default async function Page() {
  await requirePermission('operations.audit.read')
  return <StudioPage path="/studio/operations/audit" />
}
