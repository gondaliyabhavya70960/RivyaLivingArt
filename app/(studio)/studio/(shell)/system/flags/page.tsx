 ...
 * holding `studio.access`, and a link that 404s is worse than a page saying it is not built.
 *
 * THE PERMISSION CHECK IS REAL, not a placeholder. It runs before anything renders, writes a DENIED
 * audit row when it refuses, and is the same call the finished surface will make. Phase 19
...
export default async function Page() {
  await requirePermission('studio.access')
  return <StudioPage path="/studio/system/flags" />
}
